        ...
        for i in filelist:
           # sql_path = self.sql_path
            ...
            if self.target_type == 'CSV':
                ...
                target_obj = target.PostgreSQLTarget(pre_node=transform_node, database=self.database,
                                                    table_name='PostgreSQL')
            elif self.target_type == 'MySQL':
                target_obj = target.MySQLTarget(pre_node=transform_node, database=self.database,
                                                table_name='MySQL')
            else:
